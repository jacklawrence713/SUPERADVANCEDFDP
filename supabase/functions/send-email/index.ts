        ...
        emailPayload = {
          ...
          html: `
            <div style="font-family:sans-serif;max-width:560px;margin:0 auto;padding:32px 24px;background:#13111e;color:#e2e0f0;border-radius:16px">
              ...
              <h1 style="font-size:24px;font-weight:900;color:#fff;margin:0 0 12px">Welcome to Fantasy Draft Pros, ${escHtml(name || "Dynasty Manager")}!</h1>
        ...
        emailPayload = {
          ...
          html: `
            <div style="font-family:sans-serif;max-width:560px;margin:0 auto;padding:24px">
              ...
              <p><strong>Email:</strong> ${escHtml(to)}</p>
              <p><strong>Subject:</strong> ${escHtml(subject || "(none)")}</p>
              <hr/>
