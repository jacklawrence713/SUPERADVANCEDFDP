...
const DYNASTY_NEWS=[
  {id:1,ts:"Apr 17",tag:"DRAFT",pos:"RB",title:"Jeremiyah Love projected top-3 pick",body:"Notre Dame RB Jeremiyah Love expected to be a top-3 NFL Draft selection. Dynasty value surging — buy now before the draft."},
  {id:2,ts:"Apr 17",tag:"NEWS",pos:"QB",title:"Fernando Mendoza the new dynasty QB1",body:"Indiana's Mendoza is widely viewed as the top 2026 QB dynasty asset in SF leagues, with elite arm talent and pocket presence."},
  {id:3,ts:"Apr 16",tag:"TRADE",pos:"WR",title:"Carnell Tate dynasty target post-draft",body:"Ohio State's Tate continues to trend up in dynasty trade value ahead of the NFL Draft. WR1 ceiling in SF leagues."},
  ...
  {id:5,ts:"Apr 14",tag:"NEWS",pos:"TE",title:"Kenyon Sadiq top TE dynasty asset",body:"Oregon TE Sadiq is the consensus TE1 in the 2026 class. Buy in SF and TEP leagues ahead of the draft."},
  ...
  {id:8,ts:"Apr 11",tag:"DRAFT",pos:"LB",title:"Sonny Styles the premier 2026 IDP prospect",body:"Ohio State LB Sonny Styles is the top IDP prospect in the 2026 class. Three-down coverage backer with top-10 pick upside."},
...
const PLAYERS=[
  ...
  {name:"Fernando Mendoza",pos:"QB",age:22,team:"TBD",proj:{PPR:265,Half:265,Standard:265},adp:1.1,ktcVal:4753,note:"2026 #1 overall QB · Indiana · elite arm talent SF dynasty asset"},
  {name:"Ty Simpson",pos:"QB",age:22,team:"TBD",proj:{PPR:235,Half:235,Standard:235},adp:2.5,ktcVal:3031,note:"2026 1st round QB · Alabama · dual-threat upside"},
  ...
  {name:"Jadarian Price",pos:"RB",age:21,team:"TBD",proj:{PPR:195,Half:180,Standard:165},adp:2.5,ktcVal:4137,note:"2026 2nd round RB · Notre Dame · three-down potential"},
  {name:"Carnell Tate",pos:"WR",age:21,team:"TBD",proj:{PPR:160,Half:147,Standard:134},adp:1.2,ktcVal:6062,note:"2026 top-10 pick WR · Ohio State · dynasty WR1 ceiling"},
  {name:"Makai Lemon",pos:"WR",age:21,team:"TBD",proj:{PPR:148,Half:136,Standard:124},adp:1.4,ktcVal:5883,note:"2026 1st round WR · USC · elite athleticism and route running"},
  ...
  {name:"Jordyn Tyson",pos:"WR",age:22,team:"TBD",proj:{PPR:132,Half:121,Standard:110},adp:2.1,ktcVal:5594,note:"2026 1st round WR · Arizona State · big-play vertical threat"},
  {name:"Denzel Boston",pos:"WR",age:22,team:"TBD",proj:{PPR:125,Half:115,Standard:105},adp:2.2,ktcVal:4380,note:"2026 1st round WR · Washington · big body possession receiver"},
  {name:"KC Concepcion",pos:"WR",age:21,team:"TBD",proj:{PPR:115,Half:106,Standard:97},adp:3.0,ktcVal:4600,note:"2026 2nd round WR · Texas A&M · explosive slot weapon"},
  {name:"Antonio Williams",pos:"WR",age:22,team:"TBD",proj:{PPR:100,Half:92,Standard:84},adp:4.0,ktcVal:1686,note:"2026 3rd+ round WR · Clemson · depth flier with upside"},
  {name:"Kenyon Sadiq",pos:"TE",age:22,team:"TBD",proj:{PPR:118,Half:108,Standard:98},adp:1.3,ktcVal:5570,note:"2026 1st round TE · Oregon · top TE prospect elite upside"},
  // 2026 IDP Rookies
      ...
      !isPro&&React.createElement("div",{style:{marginBottom:32}},
        ...
        React.createElement("div",{style:{background:"linear-gradient(135deg,#1e1040,#1a1035)",border:"2px solid "+T.purple,borderRadius:20,padding:20,marginBottom:12,position:"relative",overflow:"hidden"}},
          ...
          showPostPayment&&React.createElement("div",{style:{marginTop:10,padding:"12px",background:T.green+"18",border:"1px solid "+T.green+"44",borderRadius:10,textAlign:"center"}},
            ...
            React.createElement("button",{disabled:postPaymentLoading,onClick:async function(){
              setPostPaymentLoading(true);
              if(authClient){var {data:sess}=await authClient.auth.getSession();if(sess?.session){var {data:prof}=await authClient.from("users").select("*").eq("id",sess.session.user.id).single();if(prof)saveAndSetUser(Object.assign({},user,{plan:prof.plan,isPro:prof.is_pro,subscriptionStatus:prof.subscription_status}));}}
              setPostPaymentLoading(false);setShowPostPayment(false);
            },style:{width:"100%",padding:"10px",borderRadius:8,border:"none",background:T.green,color:"#fff",fontWeight:700,fontSize:13,cursor:"pointer"}},postPaymentLoading?"Checking...":"I've completed payment — Activate Pro")
          ),
