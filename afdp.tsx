    ...
    tab==="rankings"&&React.createElement("div",{style:{paddingBottom:80}},
      ...
      rankSubTab==="playervalues"&&React.createElement("div",{style:{paddingBottom:16}},
        ...
        (function(){
          ...
          return rankedPlayers.filter(function(p){return p.pos!=="K"&&p.pos!=="DST"&&(pvPos==="All"||p.pos===pvPos)&&(!user||user.isPro||p.rank<=FREE_RANK_LIMIT);}).slice().sort(function(a,b){return pvVal(b)-pvVal(a);}).map(function(p,idx){
            ...
            return React.createElement("div",{key:p.name,onClick:function(){setTradeB([p]);setTradeA([]);setAnalyzed(false);setTab("trade");},style:{display:"grid",gridTemplateColumns:"44px 1fr 96px",padding:"10px 16px",borderBottom:"1px solid "+T.border,alignItems:"center",gap:4,cursor:"pointer"}},
            ...
            return trendPlayers.length===0?React.createElement("div",{style:{textAlign:"center",padding:"32px 0"}},
              ...
              return React.createElement("div",{key:x.p.name,style:{display:"flex",alignItems:"center",gap:12,padding:"10px 0",borderBottom:"1px solid "+T.border}},
                ...
                React.createElement("div",{style:{textAlign:"right",flexShrink:0,display:"flex",flexDirection:"column",alignItems:"flex-end",gap:2}},
                  ...
                  React.createElement("button",{onClick:function(){setTradeB([x.p]);setTradeA([]);setAnalyzed(false);setTab("trade");},style:{fontSize:9,fontWeight:700,color:T.purple,background:"none",border:"1px solid "+T.purple+"66",borderRadius:4,padding:"2px 6px",cursor:"pointer",marginTop:2}},"Trade →")
                )
              );
            }));
          })()
      ...
      rankSubTab==="news"&&React.createElement("div",{style:{padding:"16px",paddingBottom:32}},
        ...
        sleeperTrending&&sleeperTrending.adds&&sleeperTrending.adds.length>0&&React.createElement("div",{style:{marginTop:16}},
          ...
          sleeperTrending.adds.slice(0,5).map(function(item){
