      ...
      reportSubTab==="dynasty"&&React.createElement("div",{style:{padding:"20px 16px"}},
        React.createElement("div",{style:{display:"flex",alignItems:"flex-start",gap:14,marginBottom:8}},
          ...
          React.createElement("div",null,
            ...
            React.createElement("div",{style:{fontSize:12,color:T.textSub,marginTop:4}},"2026 Training Camp Edition · Updated August 2026")
          )
        ),
        React.createElement("div",{style:{fontSize:14,color:T.textSub,lineHeight:1.6,marginBottom:12}},"Training camp intel, value shifts & dynasty strategy for 2026"),
        React.createElement("div",{style:{display:"flex",gap:6,flexWrap:"wrap",marginBottom:16}},
        ...
        [
          {tag:"QB",tagColor:"#818cf8",title:"Josh Allen still QB1 — Mahomes fully cleared for camp",body:"Allen (7,836) holds the dynasty QB1 throne at age 30 with elite dual-threat production. Mahomes (5,438) is fully cleared after his ACL/LCL tear and is a full participant at Chiefs camp — expect less rushing volume but he's still a top-3 dynasty QB. Drake Maye (6,797) is ascending in New England with A.J. Brown now in the fold. Jayden Daniels (6,290) is the QB3 in SF after a strong sophomore season."},
          {tag:"QB",tagColor:"#818cf8",title:"2025 QBs entering Year 2: Dart leads but values have dropped",body:"Jaxson Dart (5,533) is still the crown jewel of the 2025 class — his value dropped from 6,600+ but he's a buy with elite processing and arm talent. Malik Nabers' uncertain Week 1 status hurts his early-season outlook. Cam Ward (4,579) has a firm grip on Tennessee's starting job. Shedeur Sanders (2,426) cratered in value — buy if you believe in his long-term ceiling. All three are just 23."},
          {tag:"QB",tagColor:"#818cf8",title:"2026 Rookie QBs: Mendoza sits, Beck competes in ARI",body:"Fernando Mendoza (4,738) went #1 overall to Las Vegas but HC Klint Kubiak confirmed Kirk Cousins starts Week 1. Mendoza is learning to play under center — this is a redshirt year. Carson Beck (3,605) is in a three-way competition in Arizona with Brissett and Minshew. Both are deep SF stashes — Mendoza's ceiling is enormous but patience is required."},
          {tag:"RB",tagColor:"#34d399",title:"Bijan & Gibbs are untouchable — both at 9,995+",body:"Bijan (9,999) and Gibbs (9,999) are the consensus dynasty RB1/RB2 and both are just 24. The tier break after these two is massive — Jeanty (7,992) is the RB3. If you own either, do not sell. The buy window has been closed for months."},
          {tag:"RB",tagColor:"#34d399",title:"Training camp RB risers: Brooks, Price & Chase Brown",body:"Jonathon Brooks (4,535) is dominating Panthers camp — HC Canales said 'He looks like the guy I remember.' After back-to-back ACL tears, he's finally healthy and his price is about to spike. Jadarian Price (5,826) is getting first-team reps in Seattle with Charbonnet rehabbing. Chase Brown (6,355) rose from 5,710 as the locked-in CIN bellcow. Buy all three before training camp hype pushes values higher."},
          {tag:"WR",tagColor:"#c084fc",title:"Ja'Marr Chase is the dynasty WR1 — JSN has dropped",body:"Chase (9,999) is the clear dynasty WR1. JSN (9,540) dropped from 9,998 after the offseason but remains elite at 23 in Seattle. Puka Nacua (9,229) rounds out the top tier. Justin Jefferson (7,918) is aging out of the elite tier at 27 but still a hold. The gap between these four and everyone else is significant."},
          {tag:"WR",tagColor:"#c084fc",title:"MHJ & Hunter values cratered — time to buy?",body:"Marvin Harrison Jr. (5,601) dropped from 7,000 — a 23-year-old WR1 entering Year 3 who posted 1,300 yds in Year 2. The dynasty community is massively undervaluing him. Travis Hunter (4,193) fell from 6,000 after a quiet rookie year in Jacksonville. Both are screaming buy-lows if you believe in talent over situation. Their ceilings haven't changed."},
          {tag:"WR",tagColor:"#c084fc",title:"A.J. Brown traded to NE — sell-high in dynasty",body:"A.J. Brown (5,851) was traded to the Patriots for a 2027 5th and 2028 1st. He moves from Hurts to Drake Maye, which is actually an upgrade in passing volume — Philly ranked 27th in pass rate. He's a low-end WR1 for redraft, but at 29 in dynasty this is your sell window. Move him for a young asset + pick while value is inflated."},
          {tag:"TE",tagColor:"#f59e0b",title:"Brock Bowers is the dynasty TE1 — McBride dropped to TE2",body:"Bowers (8,576) is the clear dynasty TE1 at just 24. McBride (7,772) dropped from 8,627 but remains the TE2. Loveland (6,864) is the TE3 after a breakout Year 2 in Chicago. Tyler Warren (6,524) rounds out the elite tier. If you're still holding Kelce (3,304), Kittle (4,259), or Goedert (3,338), sell for youth — the top 6 TEs are all under 27."},
          {tag:"IDP",tagColor:"#f87171",title:"IDP dynasty: Hamilton, Styles & Carter are the elite tier",body:"Kyle Hamilton (8,240) at age 26 is the top dynasty IDP asset with elite versatility. Sonny Styles (5,665) was drafted 7th overall by Washington and is an immediate three-down coverage backer. Abdul Carter flashed as a rookie edge rusher with DL1 upside at 22. The IDP market remains inefficient — use the IDP toggle in the trade analyzer to see true impact."},
          {tag:"PICK",tagColor:"#f1c40f",title:"2027 1st round picks: start accumulating now",body:"With the 2026 draft complete, smart dynasty managers are pivoting to 2027 capital. Early 2027 1sts project as the most valuable non-player assets in dynasty. If you're rebuilding, sell aging veterans for 2027 picks while contenders are focused on winning now. The 2027 class projects as deeper than 2026 at every position."},
          {tag:"TREND",tagColor:"#06b6d4",title:"Training camp signals: separate noise from signal",body:"Don't overreact to training camp hype — but do pay attention to playing time, injury reports, and coaching comments about starters. Key battles to monitor: JAX (Etienne vs. Bigsby), SEA (Price vs. Charbonnet), CAR (Brooks vs. Hubbard), ARI QB (Beck vs. Brissett vs. Minshew). The winners in each get locked-in starter value."},
          ...
          {tag:"WR",tagColor:"#c084fc",title:"Chris Olave locks in $132M extension — value stable",body:"Olave (6,428) signed a 4-year/$132M extension with New Orleans after posting 100 rec, 1,163 yds, and 9 TD in 2025. The security boost is real, but monitor rookie Jordyn Tyson (6,250) who was drafted 8th overall by the Saints and will eat into targets. Olave remains a mid-tier WR1 in dynasty at 26."},
          {tag:"TREND",tagColor:"#06b6d4",title:"Malik Nabers: dynasty buy-low of the summer",body:"Nabers (7,905) tore his ACL in 2025 and had a second knee surgery to remove scar tissue. He avoided the PUP list but says he doesn't know if he'll be ready for Week 1 vs. Dallas. Analysts project he misses the first 4-5 games. At just 22 with elite talent, this is a screaming buy-low — his value should be north of 8,000 when healthy. Buy before the season starts."}
        ...
        React.createElement("div",{style:{fontSize:11,color:T.textDim,textAlign:"center",paddingTop:8}},"Reports reflect dynasty consensus as of August 2026. Values sourced from KTC & FDP dynasty rankings.")
      ),
