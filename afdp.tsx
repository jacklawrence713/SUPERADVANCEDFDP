  ...
  return React.createElement("div",{style:{background:T.bg,minHeight:"100vh",color:T.text,fontFamily:"-apple-system,BlinkMacSystemFont,'Inter',sans-serif",maxWidth:isDesktop?"100%":480,margin:"0 auto",paddingBottom:isDesktop?0:70,display:isDesktop?"flex":"block"}},
    ...
    tab==="reports"&&React.createElement("div",{style:{paddingBottom:80}},
      ...
      reportSubTab==="dynasty"&&React.createElement("div",{style:{padding:"20px 16px"}},
        ...
        [
          {tag:"QB",tagColor:"#818cf8",title:"Allen vs. Jackson: The dynasty QB1 debate",body:"Josh Allen is the consensus dynasty QB1 heading into 2026 — his elite passing ceiling, rushing floor, and age-29 prime give him the edge in most rankings. Lamar Jackson (QB2) is the counter-argument: back-to-back MVPs and a cheaper price tag. Jalen Hurts (QB3, age 26) is the long-term value play. Jordan Love rounds out the top 5 with strong upside but not yet QB1 territory."},
