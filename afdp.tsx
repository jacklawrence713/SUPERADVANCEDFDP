...
const DYNASTY_NEWS=[
  ...
  {id:25,ts:"May 7",tag:"NEWS",pos:"WR",title:"Isaiah Likely signs massive deal with Giants — TE1 upside",body:"Likely (4,147) inked a 3yr/$40M deal with New York and immediately becomes the NYG TE1. With Russell Wilson and a new-look offense, Likely has top-8 TE upside in 2026. Buy in TEP leagues while his value hasn't caught up to his role."},
  {id:26,ts:"May 7",tag:"NEWS",pos:"QB",title:"Bijan Robinson reclaims dynasty RB1 — 9,999 KTC value",body:"Robinson (9,999) has reclaimed the #1 overall dynasty spot on KeepTradeCut, edging out JSN (9,995) and Chase (9,980). At just 24 with a locked-in three-down role in Atlanta, he's the safest dynasty asset. Hold at all costs — he's untouchable."},
  ...
  return React.createElement("div",{style:{background:T.bg,minHeight:"100vh",color:T.text,fontFamily:"-apple-system,BlinkMacSystemFont,'Inter',sans-serif",maxWidth:isDesktop?"100%":480,margin:"0 auto",paddingBottom:isDesktop?0:70,display:isDesktop?"flex":"block"}},
    ...
    tab==="reports"&&React.createElement("div",{style:{paddingBottom:80}},
      ...
      reportSubTab==="dynasty"&&React.createElement("div",{style:{padding:"20px 16px"}},
        ...
        [
          {tag:"QB",tagColor:"#818cf8",title:"Josh Allen remains QB1 — but the youth wave is coming",body:"Allen (7,657) holds the dynasty QB1 throne at age 30 with elite dual-threat production. But the real story is the next generation: Jayden Daniels (6,304) is the QB2 in SF after a stellar sophomore leap, Drake Maye (6,570) is ascending fast in New England, and Bo Nix (6,121) has quietly emerged as a top-10 dynasty QB in Denver. Meanwhile, C.J. Stroud (6,500) rebounded to cement himself as Houston's franchise cornerstone. Buy these young QBs now — their ceilings are QB1 overall."},
          ...
          {tag:"RB",tagColor:"#34d399",title:"Bijan Robinson is untouchable — Gibbs right behind",body:"Bijan (9,997) is the consensus dynasty RB1 and it's not close. Elite receiving ability, workhorse role, and just 24 years old. Gibbs (9,536) is the RB2 with the same youth profile in Detroit's explosive offense. The tier break after these two is massive. If you own either, do not sell. If you don't, the buy window is essentially closed."},
          ...
          {tag:"WR",tagColor:"#c084fc",title:"Ja'Marr Chase & JSN: The WR dynasty tier 1",body:"Chase (9,974) and Jaxon Smith-Njigba (9,996) are the clear dynasty WR1/WR2. JSN's breakout season in Seattle pushed him past Justin Jefferson (8,043) — a sell-high candidate if you can get top-5 WR value. Puka Nacua (8,880) rounds out the elite tier. The gap between these three and everyone else is enormous."},
