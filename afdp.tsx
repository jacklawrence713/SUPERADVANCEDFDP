  ...
  return React.createElement("div",{style:{background:T.bg,minHeight:"100vh",color:T.text,fontFamily:"-apple-system,BlinkMacSystemFont,'Inter',sans-serif",maxWidth:isDesktop?"100%":480,margin:"0 auto",paddingBottom:isDesktop?0:70,display:isDesktop?"flex":"block"}},
    ...
    tab==="reports"&&React.createElement("div",{style:{paddingBottom:80}},
      ...
      reportSubTab==="dynasty"&&React.createElement("div",{style:{padding:"20px 16px"}},
        ...
        [
          {tag:"QB",tagColor:"#818cf8",title:"Josh Allen: Dynasty's safest QB1",body:"Allen enters 2026 as the consensus dynasty QB1 — elite passing ceiling, a rushing floor that protects his floor in any week, and entering his age-30 season with no signs of slowing down. Jalen Hurts (age 26) is the long-term value play at a cheaper cost. Patrick Mahomes remains elite but his dynasty price reflects it — tough to acquire at value."},
