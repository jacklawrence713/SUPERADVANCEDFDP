...
const DYNASTY_NEWS=[
  ...
  {id:35,ts:"Jul 26",tag:"NEWS",pos:"RB",title:"Training camp RB battles to watch: JAX, SEA, CAR",body:"Jacksonville's Etienne vs. Bigsby battle is heating up with no clear winner yet. In Seattle, rookie Jadarian Price (5,826) is getting first-team reps with Charbonnet still rehabbing his torn ACL. Carolina's Brooks is surging (see above). These backfields will be volatile through preseason — monitor closely before drafting. The winner in each gets locked-in RB2 value."},
...
const PLAYERS=[
  ...
  {name:"Ashton Jeanty",pos:"RB",age:22.7,team:"LV",proj:{PPR:315,Half:291,Standard:267},adp:3.2,ktcVal:7992,note:"2025 pick 1-6 · Year 2: 1,600 rush 13 TD full feature back"},
  ...
  {name:"MarShawn Lloyd",pos:"RB",age:25.6,team:"GB",proj:{PPR:138,Half:126,Standard:114},adp:26.2,ktcVal:2060,note:"500 rush backup"},
  ...
  {name:"Tank Dell",pos:"WR",age:26.8,team:"HOU",proj:{PPR:205,Half:189,Standard:173},adp:19.8,ktcVal:3605,note:"75 rec 850 yds 7 TD"},
  ...
  {name:"Bhayshul Tuten",pos:"RB",age:23.5,team:"JAX",proj:{PPR:215,Half:197,Standard:179},adp:9.0,ktcVal:5500,note:"2026 draft · JAX RB · camp hype · competing with Etienne for lead role"},
  // 2025 NFL Draft class — Year 2 in 2026
  {name:"Kaleb Johnson",pos:"RB",age:23,team:"PIT",proj:{PPR:218,Half:200,Standard:182},adp:13.0,ktcVal:3193,note:"2025 pick 3-83 · Year 2: 1,050 rush 8 TD emerging feature back"},
  ...
  {name:"Quinn Ewers",pos:"QB",age:23.5,team:"MIA",proj:{PPR:248,Half:248,Standard:248},adp:25.5,ktcVal:2884,note:"MIA QB: 2,900 yds 19 TD development"},
    ...
    tab==="reports"&&React.createElement("div",{style:{paddingBottom:80}},
      ...
      reportSubTab==="dynasty"&&React.createElement("div",{style:{padding:"20px 16px"}},
        ...
        [
          ...
          {tag:"RB",tagColor:"#34d399",title:"Josh Jacobs on exempt list — GB backfield in flux",body:"Josh Jacobs (5,069) was placed on the Commissioner's Exempt List and cannot play or practice. Timeline is unclear — could be weeks or the entire season. MarShawn Lloyd and AJ Dillon move up in Green Bay. If you own Jacobs, hold but prepare contingencies. If you're contending, trade for Lloyd NOW before his price spikes."},
          ...
          {tag:"WR",tagColor:"#c084fc",title:"Jayden Higgins ACL tear — Texans WR depth crushed",body:"Jayden Higgins tore his ACL in practice and is done for 2026. The second-year WR had 500+ yds and 6 TD as a rookie and was dominating camp. Massive dynasty stash for 2027 at 23. Short-term, Nico Collins and Tank Dell see target share spikes — both are immediate risers. Buy Higgins at his floor for a 2027 payoff."},
          ...
          {tag:"TREND",tagColor:"#06b6d4",title:"Week 1 waiver wire: Allgeier, Lloyd, Stribling",body:"Top Week 1 waiver targets: Tyler Allgeier (ARI) if Jeremiyah Love sits, MarShawn Lloyd (GB) with Jacobs on the exempt list, and De'Zhaun Stribling (SF) with Pearsall out for 2026. All three have RB2/WR2 upside in Week 1 and can be acquired for near-zero cost. Import your league on Fantasy Draft Pros to see personalized waiver recommendations."},
