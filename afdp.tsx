...
const DYNASTY_NEWS=[
  ...
  {id:8,ts:"Apr 26",tag:"DRAFT",pos:"TE",title:"Kenyon Sadiq goes 1-16 to the Jets",body:"Oregon TE Sadiq (4,327) lands in New York at pick 16. Immediate TE1 upside with elite athletic profile. Must-buy in TEP leagues."},
  ...
  {id:10,ts:"Apr 26",tag:"DRAFT",pos:"QB",title:"Fernando Mendoza goes #1 overall to Raiders",body:"Indiana's Mendoza (4,753) is the 2026 #1 overall pick. Las Vegas hands him the keys — elite arm talent SF dynasty asset with rushing upside."},
    ...
    tab==="reports"&&React.createElement("div",{style:{paddingBottom:80}},
      ...
      reportSubTab==="dynasty"&&React.createElement("div",{style:{padding:"20px 16px"}},
        ...
        [
          ...
          {tag:"RB",tagColor:"#34d399",title:"Ashton Jeanty & the 2025 rookie RBs surge",body:"Jeanty (8,200) has locked in as the LV feature back and his dynasty stock is soaring. Omarion Hampton (7,359) is thriving in LAC as a three-down back. Cam Skattebo (5,479) is the NYG workhorse. Quinshon Judkins (6,534) owns the CLE backfield. The 2025 RB class delivered — hold all of them. Buy low on Jonathon Brooks (4,200) in Carolina if his owner is impatient."},
          {tag:"WR",tagColor:"#c084fc",title:"Ja'Marr Chase & JSN: The WR dynasty tier 1",body:"Chase (9,936) and Jaxon Smith-Njigba (9,794) are the clear dynasty WR1/WR2. JSN's breakout season in Seattle pushed him past Justin Jefferson (7,996) — a sell-high candidate if you can get top-5 WR value. Puka Nacua (9,501) rounds out the elite tier. The gap between these three and everyone else is enormous."},
          ...
          {tag:"TE",tagColor:"#f59e0b",title:"Brock Bowers is the dynasty TE1 — and it's not close",body:"Bowers (8,100) set the rookie TE record and is only 24. His target share in the Raiders' offense is massive. Trey McBride (7,616) is the TE2 with similar youth upside. Colston Loveland (7,218) had a breakout Year 2 in Chicago and is the TE3. The TE landscape has shifted dramatically — if you're still holding aging TEs like Kittle (4,049) or Goedert (4,000), sell for youth."},
