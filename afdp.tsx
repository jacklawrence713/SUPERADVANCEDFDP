...
const DYNASTY_NEWS=[
  {id:1,ts:"Apr 26",tag:"DRAFT",pos:"RB",title:"Jeremiyah Love lands in Arizona at 1-3",body:"Notre Dame RB Jeremiyah Love goes 3rd overall to the Cardinals. Immediate dynasty RB1 — Arizona hands him a three-down role. Buy at a slight premium."},
  {id:2,ts:"Apr 26",tag:"DRAFT",pos:"QB",title:"Fernando Mendoza goes #1 overall to Raiders",body:"Indiana's Mendoza is the 2026 #1 overall pick. Las Vegas hands him the keys — elite arm talent SF dynasty asset. Start-up leagues buy now."},
  {id:3,ts:"Apr 26",tag:"DRAFT",pos:"WR",title:"Carnell Tate lands in Tennessee at 1-4",body:"Ohio State WR Carnell Tate goes 4th overall to the Titans. Dynasty WR1 ceiling — buy on any dip. New franchise receiver in Nashville."},
  {id:4,ts:"Apr 15",tag:"NEWS",pos:"RB",title:"Kenneth Walker III lands in Kansas City",body:"Walker signed with KC after leaving SEA. Expected to see an immediate starting role — dynasty value spike incoming."},
  {id:5,ts:"Apr 26",tag:"DRAFT",pos:"TE",title:"Kenyon Sadiq goes 1-16 to the Jets",body:"Oregon TE Sadiq lands in New York at pick 16. Jets also took Omar Cooper Jr. at 1-30 — Sadiq has immediate TE1 upside. Buy in SF and TEP leagues."},
  {id:6,ts:"Apr 13",tag:"TRADE",pos:"QB",title:"Justin Fields joins KC — SF value watch",body:"Fields signed with KC. Dynasty managers should track his role — potential SF value if Mahomes were to miss time."},
  {id:7,ts:"Apr 12",tag:"NEWS",pos:"WR",title:"Tetairoa McMillan Year 2 breakout candidate",body:"Carolina WR McMillan entering Year 2 with full grasp of the offense. Elite size and route running — buy window closing."},
  {id:8,ts:"Apr 26",tag:"DRAFT",pos:"LB",title:"Sonny Styles goes 1-7 to Washington",body:"Ohio State LB Sonny Styles lands with the Commanders at pick 7. Premier IDP asset — three-down coverage backer with immediate starter upside."},
  {id:9,ts:"Apr 10",tag:"NEWS",pos:"RB",title:"Derrick Henry aging curve watch",body:"Henry turns 32 in January 2027. Dynasty managers holding the veteran RB should consider selling into remaining value."},
...
const PLAYERS=[
  ...
  {name:"Malachi Fields",pos:"WR",age:22,team:"KC",proj:{PPR:105,Half:96,Standard:87},adp:3.8,ktcVal:3000,note:"2026 pick 3-10 · KC Chiefs · dynasty sleeper in Reid offense"},
  ...
  {name:"Arvell Reese",pos:"DL",age:21,team:"NYG",proj:{PPR:102,Half:102,Standard:102},adp:1.2,ktcVal:4800,note:"2026 pick 1-5 · NYG Giants · explosive first step"},
    ...
    tab==="reports"&&React.createElement("div",{style:{paddingBottom:80}},
      ...
      reportSubTab==="dynasty"&&React.createElement("div",{style:{padding:"20px 16px"}},
        ...
        [
          ...
          {tag:"QB",tagColor:"#818cf8",title:"2026 Rookie QBs: Jaxson Dart leads a deep class",body:"Dart (6,614) is the clear QB1 of the class and has the highest dynasty ceiling of any rookie. Cam Ward (5,039) in Tennessee and Fernando Mendoza (4,753) in Las Vegas both landed in starting roles. Shedeur Sanders (3,800) in Cleveland has the arm talent but needs weapons. Carson Beck (3,500) and Drew Allar (3,400) are developmental holds. This class has long-term SF depth — acquire early."},
