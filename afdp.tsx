...
const DYNASTY_NEWS=[
  ...
  {id:16,ts:"Apr 8",tag:"TRADE",pos:"WR",title:"Jaxon Smith-Njigba: Dynasty WR2 and rising",body:"JSN (9,540) exploded in his sophomore season in Seattle and is now the dynasty WR2. At just 23, his target share is massive. He's approaching untouchable territory — only sell for an elite haul."},
];
